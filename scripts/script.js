...
document.getElementById('btn-menu').addEventListener('click', () => {
    ...
    let fullMenu = document.getElementsByClassName('menu-total')[0];
...
class DarkMode{
    constructor(){
        this.change = document.getElementById('cambiomodo');
    ...
    changeStyle(){
        ...
        let hasClass = this.body[0].classList.toggle('oscuro');
        if(hasClass){
...
/* Funcion del Search */
const Key_api = "odN3Uq9k2Co1ZLHc6Md8OtFHpsSvo53s";
...
let buttonAdd = () => {
    let div = document.querySelector('.seccion-busqueda-resultados');
...
let getImage = (urlImage) => {
    ...
    } else if (urlImage.images.downsized_medium.url) {
        return urlImage.images.downsized_medium.url;          
    } else {
        return '';
    }  
};
...
let suggestion_container = document.querySelector('.contenedor-sugerencias');
let suggest = () => {
...
let getTrendingTags = () => {
    ...
    let trendingSection = document.querySelector('.contenedor-tendencias');
